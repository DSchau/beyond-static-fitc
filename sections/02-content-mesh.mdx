...
<TwitterTweetEmbed tweetId="1067494033709297665" options={{ conversation: 'none', theme: 'dark' }} />
...
<TwitterTweetEmbed tweetId="994131019023503360" options={{ conversation: 'none', theme: 'dark' }} />
